...
#Filtros
# print('\n2 Todos os filmes de apenas Drama')
...
print('\n5- Classificação dos filmes de acordo com a duração')
#======================================================================
# 5- Categorize e rotule os filmes da seguinte forma:
#              de 0 até média de duração - Abaixo da média
...
print('\n6-Tabela de frequencia dos filmes de acordo com a duração')
TabFreqTempo=srFxTempoFilmes.value_counts()
print(TabFreqTempo)

print('\n7- Tabela de Frequencia Percentual (RELATIVA) graficamente')
TabFreqTempo.plot.pie(title='Tab Freq Percentual Grafica', figsize=(6,6), autopct='%.1f')
plt.show()

print('\n8- Tabela de Frequencia Percentual (RELATIVA) NUMERICAMENTE')
tfp = TabFreqTempo / dFilmes.shape[0] * 100
print(tfp)

print('n9- Por Nota, dos filmes de apenas DRAMA, a quantidade,o max, min de Avaliações ')
dfDrama=dFilmes.loc[dFilmes.Gênero=="Drama"]
# print(dfDrama)
